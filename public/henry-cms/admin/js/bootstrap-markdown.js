    ...
    showEditor: function() {
      ...
      if (this.$editor === null) {
        ...
        if (options.fullscreen.enable) {
          editorHeader.append('<div class="md-controls"><a class="md-control md-control-fullscreen" href="#"><i class="' + this.__getIcon(options.fullscreen.icons.fullscreenOn) + '"></i></a></div>').on('click', '.md-control-fullscreen', function(e) {
            e.preventDefault();
      ...
      icons: {
        fullscreenOn: {
          ...
          icon: {
            ...
            icomoon: 'icon-enlarge',
            themify: 'ti-fullscreen'
          }
        },
        fullscreenOff: {
          name: "fullscreenOff",
